...
export interface About extends BasePageConfig {
  ...
  studies: {
    ...
    title: string;
    /** Academic institutions (formal education) */
    academic: {
      institutions: Array<{
        /** Institution name */
        name: string;
        /** Degree or award (e.g., B.Sc.Eng.) */
        degree?: string;
        /** Field of study */
        field?: string;
        /** Timeframe (e.g., 2018 - 2022) */
        timeframe?: string;
        /** Description or notes */
        description?: React.ReactNode;
      }>;
    };
    /** Extra learning such as online courses, workshops, and certificates */
    extra?: {
      courses?: Array<{
        title: string;
        provider?: string;
  ...
  /** Activities, volunteering and organisation contributions */
  activities?: {
    /** Whether to display activities */
    display: boolean;
    /** Section title */
    title: string;
